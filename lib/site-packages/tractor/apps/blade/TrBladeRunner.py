...
class TrBladeRunner( object ):
    ...
    def sendHeartbeat (self, curstate):
        ...
        if 412 == e:
            ...
            self.eventQueue.put( (None, {'?': 'sentHeartbeat'}) )
    ...
    def nrmConnect (self, sock, event):
        ...
        # the open socket until all have been setup, then launch pixar.
        #
        # The netrender client connects each of the sockets in a
        # particular order and sends pixar 'argv' info along with the
    ...
    def launchCmd (self, cmd, now):
        ...
        if cmd.argv[0] == "TractorBuiltIn":
            if cmd.argv[1] == "Hold":
                ...
                # pixar chunks on behalf of netrender.  Ideally these
                # will be squashed into the same single pixar instance
    ...
    def handleRequest(self, sock, event):
        ...
        if req:
            if req == 'status':
                ...
                # e.g. inbound netrender sockets for pixar use
