...
# TODO:
# * how do deal with "version 0"
# * make it possible for 2.1 beta testers to upgrade --> or do they need to (may require some 2.1 renumbering)
# * make it possible for 2.0 upgraders to minimize updates
# * ensure that new adoptors don't have to go through upgrades
...
class UpgradeManager(object):
    ...
    def addVersion(self, dstVersion=None, upgrades=None, srcVersion=None, makeCurrent=True):
        ...
        if self.upgradesByVersions.has_key(key):
    ...
    def versionGraph(self):
        ...
        for srcVersion, dstVersion in self.upgradesByVersions.keys():
