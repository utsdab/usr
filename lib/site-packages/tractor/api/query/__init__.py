...
delay, undelay, delete, undelete, retry, resume, skipi, log, cattr,
...
from base import jobs, tasks, commands, invocations, blades, params, \
     ...
     delete, undelete, retry, resume, skip, log, cattr, chkeys, \
     jobdump, \
...
__all__ = (
    ...
    "undelete", "jobdump",
    "retry", "resume", "skip", "log", "cattr", "chkeys", "nimby", "unnimby",
    "trace", "eject", "delist",
