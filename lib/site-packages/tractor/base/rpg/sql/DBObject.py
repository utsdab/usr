...
class DBObject(object):
        ...
        try:
            ...
            if indb:
                ...
                if field and field.key:
                    raise DBObjectModifyKeyError, \
                          "cannot modify member '%s' of %s object, because " \
    ...
    def unpack(self):
        ...
        if self.__rowkeys__:
            rowkeys = self.__rowkeys__.keys()
        else:
            rowkeys = self.__rowdata__.keys()
        ...
        try:
            ...
            try:
                ...
                for field in vfields:
                    ...
                    if member2field.has_key(field.member):
            ...
            try:
                ...
                for alias,mem in aliases.items():
                    try:
