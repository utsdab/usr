...
/Applications/Nuke9.0v6/Nuke9.0v6.app/Contents/MacOS/Nuke9.0v6 -t /Volumes/dabrender/usr/custom/nuke/proxy_script_templates/nuke_proxy_v002.py /Volumes/dabrender/work/olivertabbott/3D_Project_2.5/renderman/set.0058_animaticv5_clean/images/set.0058_animaticv5_clean_###.exr /var/tmp/out.mov "1-720x1"
...
def splitInputPath(inputpath):
    ...
    _base = os.path.basename(inputpath)
    _dir = os.path.dirname((inputpath))
    return [_dir,_base]


def doit(inputfile, outputfile, framerange):
    print "\n"
...
if __name__ == '__main__':
    ...
    doit(inputfile, outputfile, framerange)