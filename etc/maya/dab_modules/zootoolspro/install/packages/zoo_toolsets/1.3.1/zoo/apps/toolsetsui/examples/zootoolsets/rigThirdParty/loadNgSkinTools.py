...
class LoadNgSkinTools(toolsetwidgetmaya.ToolsetWidgetMaya):
    id = "loadNgSkinTools"
    uiData = {"label": "Load NG Skin Tools",
              "icon": "ng",
              "tooltip": "Load The NG Skin Tools UI",
    ...
    def initCompactWidget(cls, parent):
        ...
        exportBox.addWidget(
            QtWidgets.QPushButton(iconlib.iconColorized("ng", size=240,
