...
class BraverabbitSkinTools(toolsetwidgetmaya.ToolsetWidgetMaya):
    id = "braverabbitSkinTools"
    uiData = {"label": "brave rabbit Skin Tools - By Ingo Clemens",
              "icon": "braverabbit",
              "tooltip": "brave rabbit Skin Tools - By Ingo Clemens",
    ...
    def initCompactWidget(cls, parent):
        ...
        exportBox.addWidget(
            QtWidgets.QPushButton(iconlib.iconColorized("braverabbit", size=240,
