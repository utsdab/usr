...
class LoadSHAPESUi(toolsetwidgetmaya.ToolsetWidgetMaya):
    id = "loadSHAPESUi"
    uiData = {"label": "Load brave rabbit SHAPES UI",
              "icon": "shapes",
              "tooltip": "Load The brave rabbit SHAPES UI - by Ingo Clemens",
    ...
    def initCompactWidget(cls, parent):
        ...
        exportBox.addWidget(
            QtWidgets.QPushButton(iconlib.iconColorized("shapes", size=240,
