...
class JointCoplanar(toolsetwidgetmaya.ToolsetWidgetMaya):
    id = "jointCoplanar"
    uiData = {"label": "Joints Coplanar Script",
              "icon": "coplanar",
              "tooltip": "Orient Joints Coplanar With This Tool",
    ...
    def initCompactWidget(cls, parent):
        ...
        exportBox.addWidget(
            QtWidgets.QPushButton(iconlib.iconColorized("coplanar", size=240,
